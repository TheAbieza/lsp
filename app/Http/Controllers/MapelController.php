...
class MapelController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/mapel/index')->with('success', 'data mata pelajaran berhasil di tamnbah');
    }
    ...
    public function destroy(Mapel $mapel)
    {
        ...
        if($mengajar){
            return back()->with('error', "$mapel->nama_mapel masih digunakan di menu belajar");
        }
